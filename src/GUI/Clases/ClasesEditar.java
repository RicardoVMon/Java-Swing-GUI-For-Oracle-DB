 ...
 * @author Daniel
 */
public class ClasesEditar extends javax.swing.JFrame {
    ...
    public ClasesEditar(int idClase) {
        initComponents();
        this.setVisible(true);
        this.setLocationRelativeTo(null);
        dbManager = new DBManager();
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Formulario de Modificación de Clases");
        ...
        cbEntrenador.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        cbEntrenador.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cbEntrenadorActionPerformed(evt);
            }
        });
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel5Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txtDescripcion, javax.swing.GroupLayout.PREFERRED_SIZE, 368, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(37, 37, 37))
                    .addGroup(jPanel5Layout.createSequentialGroup()
                    ...
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                .addComponent(cbEntrenador, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(txtCapacidad, javax.swing.GroupLayout.DEFAULT_SIZE, 474, Short.MAX_VALUE))
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel5Layout.createSequentialGroup()
                        ...
                        .addGap(9, 9, 9)))
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(txtCapacidad, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 49, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(txtHorario, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 49, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(31, 31, 31)
                .addComponent(jLabel13)
                .addGap(18, 18, 18)
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(btnModificar, javax.swing.GroupLayout.DEFAULT_SIZE, 44, Short.MAX_VALUE)
                    .addComponent(cbEntrenador))
    ...
    private void cbEntrenadorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbEntrenadorActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_cbEntrenadorActionPerformed
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        ...
        if (connection != null) {
            try {
                ...
                boolean resultado = clasesDAO.actualizarClase(connection,
                        idClase,
                        txtNombre.getText(),
                        txtDescripcion.getText(),
                        capacidad,
                        txtHorario.getText(),
                        cbEntrenador.getSelectedItem().toString());

                if (resultado) {
                    JOptionPane.showMessageDialog(this, "Clase actualizada exitosamente.", "Exito", JOptionPane.INFORMATION_MESSAGE);
                } else {
    ...
    public void obtenerDatosClase() {
        ...
        try {
            llenarComboBoxClases(connection);
            resultSet = clasesDAO.obtenerClasePorID(connection, idClase);
            ...
            if (resultSet.next()) {
                ...
                txtCapacidad.setText(resultSet.getString("CAPACIDAD"));
                txtHorario.setText(resultSet.getString("HORARIO"));

                for (int i = 0; i < cbEntrenador.getItemCount(); i++) {
                    if (cbEntrenador.getItemAt(i).equals(resultSet.getString("Nombre_completo"))) {
                        cbEntrenador.setSelectedIndex(i);
                        break;
                    }
                }
            } else {
                JOptionPane.showMessageDialog(this, "Error al encontrar datos para la clase seleccionado", "Error", JOptionPane.ERROR_MESSAGE);
            }
    ...
    public void llenarComboBoxClases(Connection conexion) {
        ...
        resultSet = personalDAO.obtenerNombresPersonal(conexion);
        try {
            cbEntrenador.removeAllItems();
            while (resultSet.next()) {
                String nombreEntrenador = resultSet.getString("Nombre_Completo");
                cbEntrenador.addItem(nombreEntrenador);
            }
        } catch (SQLException e) {
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ClasesEditar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ClasesEditar().setVisible(true);
            }
        });
    }
