 ...
 * @author Daniel
 */
public class ClasesAgregar extends javax.swing.JFrame {
    ...
    private void btnConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmarActionPerformed
        try {
            ...
            boolean resultado = clasesDAO.ingresarClase(
                    connection,
                    txtNombre.getText(),
                    txtDescripcion.getText(),
                    capacidad,
                    txtHorario.getText(),
                    cbPersonal.getSelectedItem().toString()
            );

            String mensaje = resultado ? "Clase ingresada exitosamente." : "Error al ingresar la clase.";
    ...
    public void llenarComboBoxClasesAgregar() {
        ...
        connection = dbManager.abrirConexion();
        if (connection != null) {
            resultSet = personalDAO.obtenerNombresPersonal(connection);
            try {
                cbPersonal.removeAllItems();
                while (resultSet.next()) {
                    String entrenadorNombre = resultSet.getString("Nombre_Completo");
                    cbPersonal.addItem(entrenadorNombre);
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ClasesAgregar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ClasesAgregar().setVisible(true);
            }
        });
    }
