...
public class PagosAgregar extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Formulario de Realización de Pagos");
    ...
    private void btnConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmarActionPerformed
        ...
        if (connection != null) {
            try {
                ...
                if (resultado) {
                    JOptionPane.showMessageDialog(this, "Pago ingresado exitosamente.", "Exito", JOptionPane.INFORMATION_MESSAGE);
                } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PagosAgregar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PagosAgregar().setVisible(true);
            }
        });
    }
