...
public class PagosEditar extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Formulario de Modificación de Pagos");
...
//                 Ejecuta el procedimiento almacenado
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PagosEditar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PagosEditar().setVisible(true);
            }
        });
    }
