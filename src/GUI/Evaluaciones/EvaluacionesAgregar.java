...
public class EvaluacionesAgregar extends javax.swing.JFrame {
    ...
    /**
     * Creates new form EvaluacionesAgregar
     */
    public EvaluacionesAgregar() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Formulario de Registro de Evaluaciones");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EvaluacionesAgregar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EvaluacionesAgregar().setVisible(true);
            }
        });
    }
