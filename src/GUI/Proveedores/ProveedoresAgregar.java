...
public class ProveedoresAgregar extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Formulario de Registro de Proveedores");
    ...
    private void btnConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmarActionPerformed
        try {
            ...
            boolean resultado = proveedoresDAO.ingresarProveedor(
                    connection,
                    txtNombre.getText(),
                    txtTelefono.getText(),
            ...
            String mensaje = resultado ? "Proveedor ingresado exitosamente." : "Error al ingresar el proveedor.";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProveedoresAgregar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ProveedoresAgregar().setVisible(true);
            }
        });
    }
